...
import Noheader from '../../src/dashboard/Timeheader';
...
const Win = ({ datas, userrecorddata, perioddata, latestperiod }) => {
  const finalperioddata = perioddata.filter(
    (user) => user.parity_price != null
  );
    ...
    <>
      <Noheader title="Win">
        ...
        <div className="win_tab">
          <div className="card">
            <Link href={'win'}>
              <button className="win_active">Parity</button>
            </Link>
          </div>
          <div className="card">
            <Link href={'sapre'}>
        ...
        <div className="win_table_heading">
          <p>
            <EmojiEventsOutlinedIcon />
            <span className="record_table">Parity Record</span>
          </p>
        </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="center">
                          {row.parity_price == null ? 0 : row.parity_price}
                        </TableCell>
                        <TableCell align="center">
                          {row.parity_number == null ? 3 : row.parity_number}
                        </TableCell>
                        <TableCell align="center">
                          <div className="color_center">
                            {row.parity_color == 'Red' ? (
                              <button className="red_circle"></button>
                            ) : row.parity_color == 'Green' ? (
                              <button className="green_circle"></button>
                            ) : row.parity_color == 'Voilet' ? (
                              <button className="voilet_circle"></button>
                            ) : row.parity_color == 'Voilet Green' ? (
                              <>
                                <button className="green_circle"></button>
                                <button className="voilet_circle"></button>
                              </>
                            ) : row.parity_color == 'Voilet Red' ? (
                              <>
                                <button className="red_circle"></button>
                                <button className="voilet_circle"></button>
                              </>
