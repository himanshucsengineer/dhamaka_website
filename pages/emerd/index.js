...
const Emerd = ({ datas, userrecorddata, perioddata, latestperiod }) => {
    ...
    <>
      <Noheader title="Emerd">
        ...
        <div className="win_tab">
          ...
          <div className="card">
            <Link href={'emerd'}>
              <button className="win_active">Emerd</button>
            </Link>
          </div>
        </div>
        <Container>
        ...
        <div className="win_table_heading">
          <p>
            <EmojiEventsOutlinedIcon />
            <span className="record_table">Emerd Record</span>
          </p>
        </div>
                  ...
                  .map((row) => {
                    return (
                      ...
                      >
                        ...
                        <TableCell align="center">{row.emerd_price}</TableCell>
                        <TableCell align="center">{row.emerd_number}</TableCell>
                        <TableCell align="center">
                          <div className="color_center">
                            {row.emerd_color == 'Red' ? (
                              <button className="red_circle"></button>
                            ) : row.emerd_color == 'Green' ? (
                              <button className="green_circle"></button>
                            ) : row.emerd_color == 'Voilet Green' ? (
                              <>
                                <button className="green_circle"></button>
                                <button className="voilet_circle"></button>
                              </>
                            ) : row.emerd_color == 'Voilet Red' ? (
                              <>
                                <button className="red_circle"></button>
                                <button className="voilet_circle"></button>
                              </>
