...
const Sapre = ({ datas, userrecorddata, perioddata, latestperiod }) => {
  const finalperioddata = perioddata.filter((user) => user.sapre_price != null);
    ...
    <>
      <Noheader title="Sapre">
        ...
        <div className="win_tab">
          ...
          <div className="card">
            <Link href={'sapre'}>
              <button className="win_active">Sapre</button>
            </Link>
          </div>
          <div className="card">
            <Link href={'bcone'}>
        ...
        <div className="win_table_heading">
          <p>
            <EmojiEventsOutlinedIcon />
            <span className="record_table">Sapre Record</span>
          </p>
        </div>
                  ...
                  .map((row) => {
                    return (
                      ...
                      >
                        ...
                        <TableCell align="center">{row.sapre_price}</TableCell>
                        <TableCell align="center">{row.sapre_number}</TableCell>
                        <TableCell align="center">
                          <div className="color_center">
                            {row.sapre_color == 'Red' ? (
                              <button className="red_circle"></button>
                            ) : row.sapre_color == 'Green' ? (
                              <button className="green_circle"></button>
                            ) : row.sapre_color == 'Voilet Green' ? (
                              <>
                                <button className="green_circle"></button>
                                <button className="voilet_circle"></button>
                              </>
                            ) : row.sapre_color == 'Voilet Red' ? (
                              <>
                                <button className="red_circle"></button>
                                <button className="voilet_circle"></button>
                              </>
